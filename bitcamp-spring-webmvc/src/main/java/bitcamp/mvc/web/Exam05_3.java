...
public class Exam05_3 {
    ...
    // 객체에 받을 수 있는 것은 받고, 낱개로도 받을 수 있다.
    // 테스트:
    //http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m2?no11&title=aaa&content=bbb&writer=hongkildong
    @GetMapping(value="m2")
    @ResponseBody  
    ...
    // 테스트:
    // http://localhost:8888/bitcamp-spring-webmvc/mvc/exam05_3/m3?no11&title=aaa&content=bbb&user.id=hong&user.email=hong@test.com&user.password=1111
    @GetMapping(value="m3")
    @ResponseBody  
