...
public class ApplicationContext {
    ...
    private Object createObject(Class<?> clazz) throws Exception {
        ...
        try {
            ...
            System.out.println(clazz.getName()+ "의 생성자를 호출하여 객체 생성 중 오류!");
            return null;
        }
    }
    ...
    private Object findObject(Class<?> clazz) throws Exception {
        ...
        // 만약 타입의 일치하지 않더라도 서브 클래스이거나 인터페이스 구현체인 경우에는
        // 그 객체를 리턴한다.
        ...
        try {
            ...
            System.out.println(clazz.getName() + "의 생성자를 이용하여 객체를 생성하다가 오류!");
            return null;
        }
    }
