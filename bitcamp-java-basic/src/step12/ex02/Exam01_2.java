...
// 2) 속도
// ArrayList
//    => 배열의 특징 상 특정 인덱스를 이용하여 특정 항목을 찾을 때 속도가 빠르다.
//    => 삭제할 때 이전 항목을 당겨와야 하기 때문에 속도가 느리다.
//    => 입력할 때 현재 항목을 다음 항목으로 이동해야 하기 때문에 속도가 느리다.
// LinkedList
//    => 인덱스를 이용하여 특정 항목을 찾을 때 리스트의 처음부터 찾아야하기 때문에 속도가 느리다.
//    => 삭제할 때 이전 항목과 다음 항목을 바로 연결하면 되기 때문에 속도가 빠르다.
//    => 입력할 때 현재 항목과 다음 항목을 새 항목과 연결하면 되기 때문에 속도가 빠르다.
